  ...
  render() {
    return (
      <div className={this.props.cards.length > 0 ? "display" : "display-none"}>
        <div
          className={
            this.props.loaded === true ? "display-before" : "display-after"
          }
        >
        ...
        <div className="display-wrapper">
          <div className="upd-btn-wrapper">
            <button
              onClick={this.props.updateDisplayCard}
            ...
            <div className="main-temp">
              <div className="temp-block">
                <div className="temperature-switch">
                  <button
                    onClick={this.props.convertToCels}
                    className={
                      this.props.tempConvert === false
                        ? "celcius-switcher"
                        : "celcius-switcher-after"
                    }
                  >
                    <sup>o</sup>C
                  </button>
                  <button
                    onClick={this.props.convertToFahr}
                    className={
                      this.props.tempConvert === true
                        ? "fahrenheit-switcher"
                        : "fahrenheit-switcher-after"
                    }
                  >
                    <sup>o</sup>F
                  </button>
                ...
                <p className="feelslike-temp-wrapper">
                  Feels like:
                  <span className="feelslike_temp">
                    {" "}
                    {this.props.feelsLikeTemp}
                    <sup>o</sup>
                  </span>
                </p>
              </div>
