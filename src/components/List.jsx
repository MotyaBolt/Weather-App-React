            ...
            <div className="list">
                <div className="settings">
                    ...
                    <h4>Automatic weather update every: </h4>
                      <p><input onChange={this.props.getTimeUpdate} type="radio" name='updtime' value='60' defaultChecked></input>60 minutes</p>
                      <p><input onChange={this.props.getTimeUpdate} type="radio" name='updtime' value='30'></input>30 minutes</p>
                      <p><input onChange={this.props.getTimeUpdate} type="radio" name='updtime' value='10'></input>10 minutes</p>
                    </div>
                </div>
