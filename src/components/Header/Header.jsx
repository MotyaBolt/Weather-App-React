...
export const Header = (props) => {
  ...
  const inputBlur = (e) => {
    ...
    if (!e.relatedTarget) {
      ...
      (e.relatedTarget && e.relatedTarget.id === "search-list") ||
      e.relatedTarget.className === "search-item"
    ) {
      e.preventDefault();
    } else {
      searchbox.classList.remove("cities-list-after");
  ...
  return (
    <header className={"header"}>
      ...
      <div className="header-main">
        ...
        <button onClick={props.showWeather} className="search-btn">
          Show weather
        </button>
      </div>
      <div className="page-settings">
        <div className="cels-fahr-selector">
          <div
            onClick={props.globalChangeTempCels}
            className={
              props.globalTempConvert === false
                ? "cels-block"
                : "cels-block-after"
            }
          >
          ...
          <div
            onClick={props.globalChangeTempFahr}
            className={
              props.globalTempConvert === true
                ? "fahr-block"
                : "fahr-block-after"
            }
          >
